...
public class Practice12PathEffectView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        PathEffect pathEffect1 = new DiscretePathEffect(15, 10);
        ...
        // 第三处：DashPathEffect
        PathEffect pathEffect2 = new DashPathEffect(new float[]{10, 5, 5, 5}, 0);
        ...
        PathEffect discreteEffect1 = new DiscretePathEffect(10, 15);
        ComposePathEffect pathEffect4 = new ComposePathEffect(discreteEffect1, dashEffect1);
